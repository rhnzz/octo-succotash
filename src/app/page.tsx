...
export default function LandingPage() {
  ...
  return (
      <div className="min-h-screen bg-gray-50">
        ...
        <header className="sticky top-0 z-40 bg-primary-dark shadow-sm">
          <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
            ...
            <nav className="flex items-center gap-3">
              ...
              <Link
                  href="/register"
                  className="rounded-lg bg-white px-3 py-1.5 text-sm font-semibold text-primary-dark hover:bg-gray-100 transition"
              >
                Daftar
              </Link>
            </nav>
        ...
        {/* 1. Hero Section                                                    */}
        {/* ------------------------------------------------------------------ */}
        <section className="bg-linear-to-br rom-primary-dark to-primary px-4 py-20 text-center text-white">
